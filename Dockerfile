...
ARG NEXT_PUBLIC_SEARCH_PROVIDER
ARG NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN
ARG NEXT_PUBLIC_MAPBOX_STYLE
ARG NEXT_PUBLIC_GOOGLE_ACCESS_TOKEN
ARG NEXT_PUBLIC_IMAGE_DOMAINS

ENV NEXT_PUBLIC_MAP_PROVIDER=$NEXT_PUBLIC_MAP_PROVIDER
ENV NEXT_PUBLIC_SEARCH_PROVIDER=$NEXT_PUBLIC_SEARCH_PROVIDER
ENV NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN=$NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN
ENV NEXT_PUBLIC_MAPBOX_STYLE=$NEXT_PUBLIC_MAPBOX_STYLE
ENV NEXT_PUBLIC_GOOGLE_ACCESS_TOKEN=$NEXT_PUBLIC_GOOGLE_ACCESS_TOKEN
